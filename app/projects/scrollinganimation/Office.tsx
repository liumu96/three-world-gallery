...
Command: npx gltfjsx@6.2.16 ./public/models/WawaOffice.glb --types 
*/
...
export function Office(props: JSX.IntrinsicElements["group"]) {
  ...
  const libraryRef = useRef<THREE.Group<THREE.Object3DEventMap> | null>(null);
  const atticRef = useRef<THREE.Group<THREE.Object3DEventMap> | null>(null);
